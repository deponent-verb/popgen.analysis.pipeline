...
ancient_genomes<-read_csv("~/work/MPhil/ml_review/ancient_data/ancient_df/no_deam.csv")
...
write_csv(ancient_genomes,"~/Documents/GitHub/popgen.analysis.pipeline/data/cleaned_aDNA_nodeam.csv")
