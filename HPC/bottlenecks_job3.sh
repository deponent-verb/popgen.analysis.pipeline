...
#SBATCH --time=24:30:00    	                                # walltime allocation, which has the format (D-HH:MM:SS), here set to 1 hour
#SBATCH --mem=25GB         	                                # memory required per node (here set to 4 GB)
...
R CMD BATCH bottlenecks_ss3.R
cat bottlenecks_ss3.Rout